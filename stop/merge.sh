...
hadd -f -k 01_Data.root      *Run2016B*.root *Run2016C*.root *Run2016D*.root
#hadd -f -k 01_Data.root      *Run2016*.root
hadd -f -k 02_WZTo3LNu.root  WZTo3LNu.root
hadd -f -k 03_VZ.root        ZZTo2L2Q__part*.root WZTo2L2Q__part*.root ZZTo2L2Nu__part*.root
...
#hadd -f -k 07_DYJetsToLL_M-50.root                  DYJetsToLL_M-50__part*.root
#hadd -f -k 07_DYJetsToLL_M-50-LO.root               DYJetsToLL_M-50-LO*part*.root
#hadd -f -k 07_DYJetsToLL_M-50_HT-100to200_ext1.root DYJetsToLL_M-50_HT-100to200_*part*.root
#hadd -f -k 07_DYJetsToLL_M-50_HT-200to400_ext1.root DYJetsToLL_M-50_HT-200to400_*part*.root


#signal
#hadd -f -k 00_T2tt_150to1200  
