...
class MassReconstructor 
{
	...
	//imported
	float performAllVariations(Int_t, Int_t, Int_t, TLorentzVector &, TLorentzVector &, std::vector<TLorentzVector> &, std::vector<Float_t> &, TVector2 &, 
                             std::vector<TLorentzVector>&, std::vector<TLorentzVector> &nu2, int &, int &);
