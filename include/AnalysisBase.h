...
// Fri Jun 22 13:14:41 2018 by ROOT version 6.10/09
// from TTree Events/Events
// found on file: /eos/cms/store/group/phys_higgs/cmshww/amassiro/HWWNano/Fall2017_nAOD_v1_Study2017/MCl1loose2017__baseW/nanoLatino_DYJetsToLL_M-50__part1.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         Electron_mvaFall17Iso[7];   //[nElectron]
   Float_t         Electron_mvaFall17noIso[7];   //[nElectron]
   ...
   Bool_t          Electron_mvaFall17Iso_WP80[7];   //[nElectron]
   Bool_t          Electron_mvaFall17Iso_WP90[7];   //[nElectron]
   Bool_t          Electron_mvaFall17Iso_WPL[7];   //[nElectron]
   Bool_t          Electron_mvaFall17noIso_WP80[7];   //[nElectron]
   Bool_t          Electron_mvaFall17noIso_WP90[7];   //[nElectron]
   Bool_t          Electron_mvaFall17noIso_WPL[7];   //[nElectron]
   UInt_t          nFatJet;
   ...
   UInt_t          nGenPart;
   Float_t         GenPart_eta[148];   //[nGenPart]
   Float_t         GenPart_mass[148];   //[nGenPart]
   Float_t         GenPart_phi[148];   //[nGenPart]
   Float_t         GenPart_pt[148];   //[nGenPart]
   Int_t           GenPart_genPartIdxMother[148];   //[nGenPart]
   Int_t           GenPart_pdgId[148];   //[nGenPart]
   Int_t           GenPart_status[148];   //[nGenPart]
   Int_t           GenPart_statusFlags[148];   //[nGenPart]
   ...
   Int_t           Lepton_electronIdx[6];   //[nLepton]
   Int_t           Lepton_muonIdx[6];   //[nLepton]
   Float_t         Lepton_pt[6];   //[nLepton]
   Float_t         Lepton_eta[6];   //[nLepton]
   Float_t         Lepton_phi[6];   //[nLepton]
   Float_t         Lepton_eCorr[6];   //[nLepton]
   UInt_t          nVetoLepton;
   Int_t           VetoLepton_pdgId[5];   //[nVetoLepton]
   Int_t           VetoLepton_electronIdx[5];   //[nVetoLepton]
   Int_t           VetoLepton_muonIdx[5];   //[nVetoLepton]
   Float_t         VetoLepton_pt[5];   //[nVetoLepton]
   Float_t         VetoLepton_eta[5];   //[nVetoLepton]
   Float_t         VetoLepton_phi[5];   //[nVetoLepton]
   Float_t         VetoLepton_eCorr[5];   //[nVetoLepton]
   UInt_t          nCleanJet;
   Int_t           CleanJet_jetIdx[27];   //[nCleanJet]
   Float_t         CleanJet_pt[27];   //[nCleanJet]
   Float_t         CleanJet_eta[27];   //[nCleanJet]
   Float_t         CleanJet_phi[27];   //[nCleanJet]
   Int_t           Lepton_isLoose[6];   //[nLepton]
   Int_t           Lepton_isVeto[6];   //[nLepton]
   Int_t           Lepton_isWgs[6];   //[nLepton]
   Float_t         dmZll_veto;
   Int_t           Lepton_isTightElectron_mvaFall17noIso_WP80[6];   //[nLepton]
   Int_t           Lepton_isTightElectron_mvaFall17noIso[6];   //[nLepton]
   Int_t           Lepton_isTightElectron_mvaFall17noIso_WP90[6];   //[nLepton]
   Int_t           Lepton_isTightElectron_mvaFall17Iso[6];   //[nLepton]
   Int_t           Lepton_isTightElectron_mvaFall17noIso_WPL[6];   //[nLepton]
   Int_t           Lepton_isTightElectron_mvaFall17Iso_WP90[6];   //[nLepton]
   Int_t           Lepton_isTightElectron_mvaFall17Iso_WPL[6];   //[nLepton]
   Int_t           Lepton_isTightElectron_mvaFall17Iso_WP80[6];   //[nLepton]
   Int_t           Lepton_isTightMuon_cut_Medium80x[6];   //[nLepton]
   Int_t           Lepton_isTightMuon_cut_Tight80x_HWWW[6];   //[nLepton]
   Int_t           Lepton_isTightMuon_cut_Tight80x[6];   //[nLepton]
   Float_t         puWeight;
   Float_t         puWeightUp;
   ...
   Float_t         mllll_zh4l;
   Float_t         chllll_zh4l;
   Float_t         Jet_btagSF[31];   //[nJet]
   Float_t         Jet_btagSF_up[31];   //[nJet]
   Float_t         Jet_btagSF_down[31];   //[nJet]
   Float_t         Jet_btagSF_shape[31];   //[nJet]
   Float_t         Jet_btagSF_shape_up_jes[31];   //[nJet]
   Float_t         Jet_btagSF_shape_down_jes[31];   //[nJet]
   Float_t         Jet_btagSF_shape_up_lf[31];   //[nJet]
   Float_t         Jet_btagSF_shape_down_lf[31];   //[nJet]
   Float_t         Jet_btagSF_shape_up_hf[31];   //[nJet]
   Float_t         Jet_btagSF_shape_down_hf[31];   //[nJet]
   Float_t         Jet_btagSF_shape_up_hfstats1[31];   //[nJet]
   Float_t         Jet_btagSF_shape_down_hfstats1[31];   //[nJet]
   Float_t         Jet_btagSF_shape_up_hfstats2[31];   //[nJet]
   Float_t         Jet_btagSF_shape_down_hfstats2[31];   //[nJet]
   Float_t         Jet_btagSF_shape_up_lfstats1[31];   //[nJet]
   Float_t         Jet_btagSF_shape_down_lfstats1[31];   //[nJet]
   Float_t         Jet_btagSF_shape_up_lfstats2[31];   //[nJet]
   Float_t         Jet_btagSF_shape_down_lfstats2[31];   //[nJet]
   Float_t         Jet_btagSF_shape_up_cferr1[31];   //[nJet]
   Float_t         Jet_btagSF_shape_down_cferr1[31];   //[nJet]
   Float_t         Jet_btagSF_shape_up_cferr2[31];   //[nJet]
   Float_t         Jet_btagSF_shape_down_cferr2[31];   //[nJet]
   Float_t         btagWeight;
...
AnalysisBase::AnalysisBase(TTree *tree) : fChain(0) 
{
  ...
  TString filepath = "/eos/cms/store/group/phys_higgs/cmshww/amassiro/HWWNano/Fall2017_nAOD_v1_Study2017/MCl1loose2017__baseW/";
  TString filename = "nanoLatino_ZZTo4L__part2.root";
  //  TString filename = "nanoLatino_DYJetsToLL_M-50__part1.root";

  printf("\n [AnalysisBase] Reading %s%s\n\n", filepath.Data(), filename.Data());


  if (tree == 0) {
    TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject(filepath + filename);
    if (!f || !f->IsOpen()) {
      f = new TFile(filepath + filename);
    }
