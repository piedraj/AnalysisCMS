		...
		TString schannel)
{
 ...
 nominalError     = sqrt(h_fakes -> GetSumw2()->At(1));
 upError          = sqrt(h_fakes -> GetSumw2()->At(2));
 downError        = sqrt(h_fakes -> GetSumw2()->At(3));
 statUpError      = sqrt(h_fakes -> GetSumw2()->At(4));
 statDownError   = sqrt(h_fakes -> GetSumw2()->At(5));
