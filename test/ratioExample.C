...
void ratioExample()
{
  printf("\n This is a ratio plot example with asymmetry errors, made by Lorenzo Moneta on June 14th, 2016\n\n");
  ...
  h2->Scale(1./4.);  // Scale second histogram to same entries as first one
