...
#ifndef nanoFakesDataRunC_h
#define nanoFakesDataRunC_h
...
class nanoFakesDataRunC : public TSelector {
public :
   ...
   nanoFakesDataRunC(TTree * /*tree*/ =0) { }
   virtual ~nanoFakesDataRunC() { }
   ...
   ClassDef(nanoFakesDataRunC,0);

};

#endif

#ifdef nanoFakesDataRunC_cxx
void nanoFakesDataRunC::Init(TTree *tree)
{
...
Bool_t nanoFakesDataRunC::Notify()
{
...
#endif // #ifdef nanoFakesDataRunC_cxx
