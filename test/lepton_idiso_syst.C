...
void lepton_idiso_syst(TString filename = "latino_WWTo2L2Nu.root")
{
  ...
  latino->Draw("0.5*1e2*(LepSF2l__ele_cut_WP_Tight80X__Up-LepSF2l__ele_cut_WP_Tight80X__Do)/LepSF2l__ele_cut_WP_Tight80X__mu_cut_Tight80x>>h_ele", lepton_pt && electrons);
  ...
  latino->Draw("0.5*1e2*(LepSF2l__mu_cut_Tight80x__Up-LepSF2l__mu_cut_Tight80x__Do)/LepSF2l__ele_cut_WP_Tight80X__mu_cut_Tight80x>>h_mu", lepton_pt && muons);
