...
hadd -f -k 02_WZ.root       WZJets.root WZTo2L2Q.root
hadd -f -k 03_ZZ.root       ZZ.root ZZTo2L2Q.root ggZZ*.root
...
hadd -f -k 05_WW.root       WWTo2L2Nu.root WWToLNuQQ.root GluGluWWTo2L2Nu_MCFM.root
...
hadd -f -k 09_HWW.root      GluGluHToWWTo2L2Nu_M125.root VBFHToWWTo2L2Nu_M125.root HWplusJ_HToWW_M125.root HWminusJ_HToWW_M125.root HZJ_HToWW_M125.root ttHJetToNonbb_M125.root
