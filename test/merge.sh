...
hadd  -f -k 04_ST_tw.root      ST_tW_antitop.root ST_tW_top.root
hadd  -f -k 04_TTbar.root      TTTo2L2Nu.root 
...
hadd  -f -k 09_HWW.root        GluGluHToWWTo2L2Nu_M124.root VBFHToWWTo2L2Nu_M124.root ttHJetToNonbb_M125.root
hadd  -f -k 10_Wg.root         Wg500.root
hadd  -f -k 11_Zg.root         Zg.root
hadd -f -k  12_VVV.root        WZZ.root
hadd -f -k  13_HZ.root         HZJ_HToWW_M125.root
