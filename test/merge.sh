...
#hadd -f -k 97_WZ.root        WZTo3LNu.root WZTo2L2Q__part*.root
#hadd -f -k 98_ZZ.root        ZZTo2L2Q*.root 
#hadd -f -k 07_ZJets.root     DYJetsToLL_M-10to50.root DYJetsToLL_M-50_*.root
#hadd -f -k 02_WZTo3LNu.root  WZTo3LNu.root
#hadd -f -k 03_VZ.root        ZZTo2L2Q*.root WZTo2L2Q__part*.root
#hadd -f -k 04_TTTo2L2Nu.root TTTo2L2Nu_ext*.root
...
hadd -f -k 10_TTZ.root       TTZjets.root
...
#hadd -f -k 20_T2tt_mStop-150to1200.root T2tt_mStop-*.root
