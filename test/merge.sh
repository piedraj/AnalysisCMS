...
hadd -f -k 02_WZTo3LNu.root  WZTo2L2Q*.root WZTo3LNu.root 
hadd -f -k 03_ZZ.root        ZZTo2L2Q*.root
...
#hadd -f -k 11_Wg.root        Wg.root Wg500.root 
#hadd -f -k 11_Wg.root        Wg_AMCNLOFXFX.root // Wg_AMCNLOFXFX.root does not exits in latinos configuration web
#hadd -f -k 12_Zg.root        Zg.root // does not exits in latinos configuration web
hadd -f -k 13_VVV.root       WZZ.root ZZZ.root WWW.root WWZ.root
