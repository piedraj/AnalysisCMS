...
hadd -f -k 04_TTTo2L2Nu.root TTTo2L2Nu_ext1__part*.root  #TTTo2L2Nu.root
...
hadd -f -k 10_HWW.root       GluGluHToWWTo2L2Nu_M125.root VBFHToWWTo2L2Nu_M125.root ttHJetToNonbb_M125.root GluGluHToTauTau_M125.root VBFHToTauTau_M125.root HWminusJ_HToWW_M125.root HWplusJ_HToWW_M125.root #also Htt and WH
hadd -f -k 11_Wg.root        Wg_MADGRAPHMLM.root #Wg_AMCNLOFXFX.root
