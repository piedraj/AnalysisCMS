...
const TCut mycut           = "eventW          *(metPfType1>80.)";//&&mt2ll>100.&&darkpt>0.)";  
const TCut mycut3          = "eventW          *(newdarkpt>0.)";  
const TCut mycuty          = "eventW          *(mt2ll>75.&&mt2ll<100.&&darkpt>0.&&metPfType1>80.)";  
...
void CreateHistograms(){
	...
	CreateHistograms2("01_Data_reduced_1outof6");
	...
	CreateHistograms2("09_TTV_updated");
...
void CreateHistograms2( TString process ){ 
	...
	//TFile* myfile = new TFile( "/afs/cern.ch/user/c/cprieels/work/public/ForJuan/SSMinitrees/" + process + ".root", "read" ); 
	...
	if ( process == "04_TTTo2L2Nu" ) thecut = "0.97*eventW*toppTRwW*(metPfType1>80.)"; 
	if ( process == "07_ZJets"     ) thecut = "1.07*eventW*(metPfType1>80.)"; 

	//TCut thecut = ( process == "04_TTTo2L2Nu" || process == "ttDM0001scalar00010") ? "1.05*eventW*(metPfType1>80.&&mt2ll>100.&&darkpt>0.)" : mycut ; 
	...
	//mytree -> Draw( b_name[topRecoW     ] + " >> " + h_name[topRecoW     ] + "(  50,  0.00,   0.01)", thecut );
