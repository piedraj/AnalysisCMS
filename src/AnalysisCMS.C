...
void AnalysisCMS::ApplyWeights()
{
  ...
  if (std_vector_lepton_idisoW)
	...
	{
	  sf_btag = bPogSF_CSVM;
	  sf_btag_up = bPogSF_CSVM_Up  ;   // if (_systematic_btag_up) sf_btag = bPogSF_CSVM_Up;
	  sf_btag_do = bPogSF_CSVM_Down;   // if (_systematic_btag_do) sf_btag = bPogSF_CSVM_Down;
	}
      else
	{
	  sf_btag = bPogSF_CMVAL;
	  sf_btag_up = bPogSF_CMVAL_Up  ;   // if (_systematic_btag_up) sf_btag = bPogSF_CMVAL_Up;
	  sf_btag_do = bPogSF_CMVAL_Down;   // if (_systematic_btag_do) sf_btag = bPogSF_CMVAL_Down;
	}
      ...
      float sf_trigger_up = effTrigW_Up;   // if (_systematic_trigger_up) sf_trigger = effTrigW_Up;
      float sf_trigger_do = effTrigW_Down; // if (_systematic_trigger_do) sf_trigger = effTrigW_Down;
      ...
      if (_analysis.EqualTo("WZ"))
	{
      ...
      _event_weight_Btagup    = (sf_btag_up/sf_btag) * _event_weight;
      _event_weight_Btagdo    = (sf_btag_do/sf_btag) * _event_weight;
      _event_weight_Idisoup   = (sf_idiso_up/sf_idiso) * _event_weight;
      _event_weight_Idisodo   = (sf_idiso_do/sf_idiso) * _event_weight;
      _event_weight_Triggerup = (sf_trigger_up/sf_trigger) * _event_weight;   
      //cout << _event_weight_Triggerup << " -- " << sf_trigger_up << " -- " << sf_trigger << " -- " << _event_weight <<  endl;
      _event_weight_Triggerdo = (sf_trigger_do/sf_trigger) * _event_weight;
      _event_weight_Recoup    = (sf_reco_up/sf_reco) * _event_weight;
      _event_weight_Recodo    = (sf_reco_do/sf_reco) * _event_weight;
