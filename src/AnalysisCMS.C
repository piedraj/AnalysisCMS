				   ...
				   TString suffix)
{
  ...
  h_lep1eta      [ichannel][icut][ijet] = new TH1D("h_lep1eta"       + suffix, "",  100, -2.6,  2.6);
  h_lep2eta      [ichannel][icut][ijet] = new TH1D("h_lep2eta"       + suffix, "",  100, -2.6,  2.6);
  ...
  h_lep1phi      [ichannel][icut][ijet] = new TH1D("h_lep1phi"       + suffix, "",  100, -3.2,  3.2);
  h_lep2phi      [ichannel][icut][ijet] = new TH1D("h_lep2phi"       + suffix, "",  100, -3.2,  3.2);
  h_jet1phi      [ichannel][icut][ijet] = new TH1D("h_jet1phi"       + suffix, "",  100, -3.2,  3.2);
  h_jet2phi      [ichannel][icut][ijet] = new TH1D("h_jet2phi"       + suffix, "",  100, -3.2,  3.2);
  h_metPfType1Phi[ichannel][icut][ijet] = new TH1D("h_metPfType1Phi" + suffix, "",  100, -3.2,  3.2);
  h_metTtrkPhi   [ichannel][icut][ijet] = new TH1D("h_metTtrkPhi"    + suffix, "",  100, -3.2,  3.2);
