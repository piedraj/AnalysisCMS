...
// Thu Jul  2 14:39:55 2015 by ROOT version 6.02/05
// from TTree latino/probe_tree
// found on file: /gpfs/csic_projects/cms/piedra/latino/latino_WZJets_PHYS14.root
//////////////////////////////////////////////////////////
...
#ifdef AnalysisWZ_cxx
AnalysisWZ::AnalysisWZ(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/gpfs/csic_projects/cms/piedra/latino/latino_WZJets_PHYS14.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/gpfs/csic_projects/cms/piedra/latino/latino_WZJets_PHYS14.root");
      }
...
Int_t AnalysisWZ::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t AnalysisWZ::LoadTree(Long64_t entry)
{
...
void AnalysisWZ::Init(TTree *tree)
{
...
void AnalysisWZ::Show(Long64_t entry)
{
...
Int_t AnalysisWZ::Cut(Long64_t entry)
{
