	  ...
	  if (analysis.EqualTo("MonoH"))
	    {
	      ...
	      plotter.Draw(prefix + "deltarjet1met"   + suffix, "#DeltaR(jet1,E_{T}^{miss})",     5, 2, "rad",  scale);
	      plotter.Draw(prefix + "deltarjet2met"   + suffix, "#DeltaR(jet2,E_{T}^{miss})",     5, 2, "rad",  scale);
	      plotter.Draw(prefix + "deltarjj"        + suffix, "#DeltaR(jet1,jet2)",             5, 2, "rad",  scale);
	      plotter.Draw(prefix + "deltarjjmet"     + suffix, "#DeltaR(jj,E_{T}^{miss})",       5, 2, "rad",  scale);
	      plotter.Draw(prefix + "deltarlep1jet1"  + suffix, "#DeltaR(lep1,jet1)",             5, 2, "rad",  scale);
	      plotter.Draw(prefix + "deltarlep1jet2"  + suffix, "#DeltaR(lep1,jet2)",             5, 2, "rad",  scale);
	      plotter.Draw(prefix + "deltarlep2jet1"  + suffix, "#DeltaR(lep2,jet1)",             5, 2, "rad",  scale);
	      plotter.Draw(prefix + "deltarlep2jet2"  + suffix, "#DeltaR(lep2,jet2)",             5, 2, "rad",  scale);
