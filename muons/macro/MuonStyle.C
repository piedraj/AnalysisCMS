...
TCanvas * MuonStyle::newCanvas(TString title="", Int_t xdiv=1, Int_t ydiv =1, Int_t w=600, Int_t h=600){
...
// Type = "png", "eps", etc.
void MuonStyle::printCanvases(TString type){
