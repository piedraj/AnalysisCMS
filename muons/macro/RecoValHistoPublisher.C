...
void RecoValHistoPublisher(char* newFile=(char*)"NEW_FILE",char* refFile=(char*)"REF_FILE") {
  ...
  TList* sl = testt.getListOfBranches(dataType, sfile, "MuonRecoAnalyzer");
  if (!sl) {
  ...
  TList* rl = testt.getListOfBranches(dataType, rfile, "MuonRecoAnalyzer");
  if (!rl) {
    cout << "ERROR: Could not find keys!!!" << endl;
    cerr << "ERROR: Could not find keys!!!" << endl;
    return;
  ...
  while (rKey) {
    ...
    testt.Plot4Histograms(newDir + "/muonReco1.pdf",
		    rdir, sdir, 
		    rcollname, scollname,
		    ...
		    plots1, plotst1,
		    logy, doKolmo, snorm_1,resol, minx,maxx);
    ...
    Double_t snorm_2  [] = {0.,0.,0.,0.};

    testt.Plot4Histograms(newDir + "/muonReco2.pdf",
		    rdir, sdir, 
		    rcollname, scollname,
		    ...
		    refFileLabel, newFileLabel,
		    plots2, plotst2,
		    logy, doKolmo, snorm_2,resol, minx1,maxx1);
    ...
    Double_t snorm_3  [] = {0.,0.,0.,0.};
    testt.Plot4Histograms(newDir + "/muonReco3.pdf",
		    rdir, sdir, 
		    rcollname, scollname,
		    ...
		    refFileLabel, newFileLabel,
		    plots3, plotst3,
		    logy, doKolmo, snorm_3,resol,minx1,maxx1);
    ...
    Double_t snorm_4  [] = {0.,0.,0.,0.};
    testt.Plot4Histograms(newDir + "/muonReco4.pdf",
		    rdir, sdir, 
		    rcollname, scollname,
		    ...
		    refFileLabel, newFileLabel,
		    plots4, plotst4,
		    logy, doKolmo, snorm_4,resol,minx1,maxx1);
    ...
    Double_t snorm_5  [] = {0.,0.,0.,0.};
    testt.Plot4Histograms(newDir + "/muonReco5.pdf",
		    rdir, sdir, 
		    rcollname, scollname,
		    ...
		    refFileLabel,newFileLabel,
		    plots5, plotst5,
		    logy, doKolmo, snorm_5,resol,minx1,maxx1);
